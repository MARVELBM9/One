const marvelRawData = [
    ...
    { id: "m3", title: "Spider-Man 3", year: "2007", duration: "ساعتان و20 دقيقة", poster: "https://www.image2url.com/r2/default/images/1785746723860-7f0c9352-a713-4e75-ab2b-daef773aba12.jpg" },
    ...
    { id: "m34", title: "Thor: Love and Thunder", year: "2022", duration: "ساعة و58 دقيقة", poster: "https://image.tmdb.org/t/p/w500/pIkRyD18kl4FhoCNQuWxWu5cBLM.jpg" },
    ...
    { id: "m36", title: "Ant-Man and the Wasp: Quantumania", year: "2023", duration: "ساعتان و4 دقائق", poster: "https://image.tmdb.org/t/p/w500/ngl2FKBlU4fhbdsrtdom9LVLBXw.jpg" },
...
const mcuAvengersReleaseIds = [
    ...
    "m9", "m10", "m12", "m13", "m14", "m11", "m15",
    "m16", "c24", "m17", "c25", "m18", "m20", "m21",
    "m22", "m23", "m24", "venom1", "m25", "m26",
    "m27", "m28", "m29", "s14", "s15", "s16", "m19",
    "m30", "venom2", "m31", "s18", "m32", "m33",
    "s19", "s20", "m34", "s22", "s23", "m35", "s24",
    "m37", "m36", "s25", "s26", "m38", "s27", "s28",
    "venom3", "s30", "m40", "m41", "m42", "s32", "m43"
];

const mcuAvengersChronoIds = [
    "m1", "m2", "m3", "m10", "m11", "m8", "c24", "c25",
    "m27", "m4", "m6", "m5", "m7", "m9", "m12", "m13",
    "m14", "m15", "m21", "m16", "m17", "m18", "m19",
    "m24", "m22", "m20", "m23", "m26", "m25", "m28",
    "s16", "s26", "s14", "s15", "m30", "m31", "venom1",
    "m29", "venom2", "m32", "m33", "venom3", "s18",
    "s19", "s20", "m35", "s27", "s22", "m34", "s23",
    "s24", "m37", "m36", "s25", "m38", "s28", "s30",
    "m40", "m41", "m42", "s32", "m43"
];
...
function renderTypeSelection() {
    ...
    if (currentUniverse === 'mcu') {
        ...
        container.innerHTML = `
            <div class="uni-card type-card type-uniform"
                 onclick="openType('avengers')">
