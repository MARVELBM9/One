...
const mcuAvengersReleaseIds = [
    ...
    "m29", "s14", "s15", "s16", "m19", "venom2", "m30", "m31", "s18", "m32", "m33", "m34", "s23", "s19",
    "s20", "s22", "s24", "m36", "m35", "s23", "m37", "s25", "s26", "m38", "venom3", "s27", "s28", "s30",
    "m40", "m41", "m42", "s32", "m43"
];

const mcuAvengersReleaseIds = [
    "m1", "m2", "m3", "m4", "m5", "m6", "m7", "m8", "m9", "m10", "m12", "m13", "m11", "m14", "m15", "m16",
    "c24", "m17", "c25", "m18", "m20", "m21", "m22", "m23", "m24", "venom1", "m25", "m26", "m27", "m28",
    "m29", "s14", "s15", "s16", "m19", "venom2", "m30", "m31", "s18", "m32", "m33", "m34", "s23", "m35",
    "s19", "s20", "s22", "s24", "m36", "m37", "s25", "s26", "m38", "venom3", "s27", "s28", "s30",
    "m40", "m41", "m42", "s32", "m43"
];

// التعديل المخصص لقائمة الإصدار (Release) بناءً على طلبك تماماً:
// 1. مسلسل Agent Carter - Season 2 (c25) بعد فيلم Ant man (m17)
// 2. فيلم Black Panther: Wakanda Forever (m35) بعد Werewolf by Night (s23) مباشرةً
const mcuAvengersReleaseIds = [
    "m1", "m2", "m3", "m4", "m5", "m6", "m7", "m8", "m9", "m10", "m12", "m13", "m14", "m11", "m15", "m16",
    "c24", "m17", "c25", "m18", "m20", "m21", "m22", "m23", "m24", "venom1", "m25", "m26", "m27", "m28",
    "m29", "s14", "s15", "s16", "m19", "venom2", "m30", "m31", "s18", "m32", "m33", "m34", "s23", "m35",
