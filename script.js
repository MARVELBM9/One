const marvelRawData = [
    ...
    { id: "m3", title: "Spider-Man 3", year: "2007", duration: "ساعتان و19 دقيقة", poster: "https://www.image2url.com/r2/default/images/1785746723860-7f0c9352-a713-4e75-ab2b-daef773aba12.jpg" },
    ...
    { id: "m27", title: "Captain Marvel", year: "2019", duration: "ساعتان و3 دقائق", poster: "https://www.image2url.com/r2/default/images/1785618061721-b02169d4-17bd-40ca-951e-4d92d1bc06da.jpg" },
    ...
    { id: "s23", title: "Werewolf by Night", year: "2022", duration: "حلقة واحدة", poster: "https://www.image2url.com/r2/default/images/1785622110320-7eea451f-40c1-4784-bd38-1b0ad8299872.jpg" },

    { id: "s24", title: "The Guardians of the Galaxy Holiday Special", year: "2022", duration: "حلقة واحدة", poster: "https://www.image2url.com/r2/default/images/1785622165686-25fa15ad-9bda-4420-8eff-302e1d5d2b6b.jpg" },
    ...
    { id: "s31", title: "The Punisher: One Last Kill", year: "2026", duration: "حلقة واحدة", poster: "https://www.image2url.com/r2/default/images/1785623239251-33b1a791-ee77-4e4f-a919-39936b1bd8fa.jpg" },
...
const foxXmenReleaseIds = [
    "x1", "x2", "x3", "x4", "x5", "x6", "x7",
    "x8", "x9", "x10", "x11", "x12", "x13", "m39"
];

const foxXmenChronoIds = [
    "x5", "x7", "x4", "x9", "x12", "x1", "x2",
    "x3", "x6", "x8", "x11", "m39", "x13", "x10"
];
...
const mcuDefendersReleaseIds = [
    "s1", "s2", "s3", "s4", "s5", "s6", "s7", "s8",
    "s9", "s10", "s11", "s12", "s13", "s29", "s33", "s31"
];

const mcuDefendersChronoIds = [
    "s1", "s2", "s3", "s4", "s5", "s6", "s7", "s8",
    "s9", "s10", "s11", "s12", "s13", "s29", "s33", "s31"
];
...
const mcuAvengersReleaseIds = [
    ...
    "m10", "m12", "m13", "m14", "m11", "m15", "m16",
    "c24", "m17", "c25", "m18", "m20", "m21", "m22", "m23",
    "m24", "venom1", "m25", "m26", "m27", "m28",
    "m29", "s14", "s15", "s16", "m19", "m30", "venom2",
    "m31", "s18", "m32", "m33", "s19", "s20", "m34",
    "s22", "s23", "m35", "s24", "m37", "m36", "s25", "s26",
    "m38", "s27", "s28", "venom3", "s30", "m40", "m41",
    "m42", "s32", "m43"
];

const mcuAvengersChronoIds = [
    "m1", "m2", "m3", "m10", "m11", "m8", "c24", "c25",
    "m27", "m4", "m6", "m5", "m7", "m9", "m12", "m13",
    "m14", "m15", "m21", "m16", "m17", "m18", "m19", "m24",
    "m22", "m20", "m23", "m26", "m25", "m28",
    "s16", "s26", "s14", "s15", "m30", "m31", "venom1",
    "m29", "venom2", "m32", "m33", "venom3", "s18",
    "s19", "s20", "m35", "s27", "s22", "m34", "s23", "s24",
    "m37", "m36", "s25", "m38", "s28", "s30",
    "m40", "m41", "m42", "s32", "m43"
];


let watchedList =
    JSON.parse(localStorage.getItem('marvel_watched_v6')) || {};

let favList =
    JSON.parse(localStorage.getItem('marvel_favorites_v1')) || {};
...
function renderTypeSelection() {
    ...
    const container =
        document.getElementById('typeCardsContainer');

    const logo =
        document.getElementById('typeSelectionLogo');
    ...
    if (currentUniverse === 'mcu') {
        ...
        if (logo) {
            logo.innerHTML = 'MCU <span>CATEGORY</span>';
        }
        ...
        if (logo) {
            logo.innerHTML = 'FOX <span>CATEGORY</span>';
        }
...
function showView(hash) {
    ...
    const uniSel =
        document.getElementById('universeSelection');
    ...
    if (uniSel) {
        uniSel.classList.add('hidden-content');
    }

    if (typeSel) {
        typeSel.classList.add('hidden-content');
    }

    if (mainCont) {
        mainCont.classList.add('hidden-content');
    }
    ...
    if (hash === '#universe') {
        ...
        if (uniSel) {
            uniSel.classList.remove('hidden-content');
        }
        ...
        if (typeSel) {
            typeSel.classList.remove('hidden-content');
        }
...
function renderTabs() {
    ...
    tabs.forEach(tab => {
        ...
        btn.className =
            `tab-btn ${currentTab === tab.id ? 'active' : ''}`;
...
function getDisplayIds() {
    ...
    if (currentUniverse === 'fox') {
        ...
        if (currentType === 'defenders') {
            ...
            return currentTab === 'release'
                ? mcuDefendersReleaseIds
                : mcuDefendersChronoIds;
            ...
            return currentTab === 'release'
                ? mcuAvengersReleaseIds
                : mcuAvengersChronoIds;
        ...
        card.innerHTML = `
            ...
            <div class="poster-box">
                ...
                <div
                    ...
                    onclick="toggleFav('${id}', this, event)"
                >
            ...
            <div class="card-details">
                ...
                <button
                    class="watch-btn"
                    onclick="toggleWatched('${id}', this, event)"
                >
